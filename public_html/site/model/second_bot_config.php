...
			"Http_Enable" => array("type"=>"str","value"=>null),
			"Security_WebUIKey" => array("type"=>"str","value"=>null),
...
		public function get_Http_Enable()
		{
			return $this->get_field("Http_Enable");
		}
		public function get_Security_WebUIKey()
		{
			return $this->get_field("Security_WebUIKey");
