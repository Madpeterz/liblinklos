...
abstract class genClass_collection_get extends genClass_collectionSet
{
    ...
    public function get_linked_array($left_side_field="",$right_side_field="")
    {
        $return_array = array();
    ...
    public function get_unique_array($field_name="")
    {
        $found_values = array();
    ...
    public function get_object_by_id($id=null)
    {
        if($this->worker == null) $this->worker = new $this->worker_class();
        $use_field = "id";
        if($this->worker->bad_id == true) $use_field = $this->worker->use_id_field;
    ...
    public function get_all_by_field($fieldname="")
    {
